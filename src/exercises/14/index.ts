 ...
 */
export function map<T>(mapper, input:T[]) {
 ...
 * @return {Array | Function}
 */
export function filter<T>(filterer, input:T[]) {
    if (arguments.length === 0) {
        return map;
    }
    if (arguments.length === 1) {
 ...
 */
export function add(a:number, b:number):number| typeof add {
    if (arguments.length === 0) {
        return add;
    }
    if (arguments.length === 1) {
 ...
 * @return {Number | Function}
 */
export function subtract(a:number, b:number):number| typeof subtract{
    if (arguments.length === 0) {
        return add;
    }
    if (arguments.length === 1) {
